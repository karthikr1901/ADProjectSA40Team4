<%@ Page Title="Request Report" Language="C#" MasterPageFile="~/StoreSupervisor.master" AutoEventWireup="true" CodeFile="RequestReport.aspx.cs" Inherits="Store_Supervisor_GenerateOrderReport" %>
...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container-body">
        <div class="container">
            <h2 style="text-align: center">Generate Request Report</h2>
            <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        </div>
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center">Request Report Preferences</div>
            <div class="panel-body">
             ...
             <div class="form-group">
                    ...
                    <asp:GridView ID="RequestGridView" CssClass="table table-striped table-hover" runat="server" AutoGenerateColumns="False" CellPadding="1" HorizontalAlign="Left">
                        <Columns>
                            <asp:BoundField HeaderText="Department" DataField="DepartmentName" ReadOnly="true" />
